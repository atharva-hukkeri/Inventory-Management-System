...
class supplierClass:
    def __init__(self, root):
        ...
        butn_search=Button(self.root,text="Search",command=self.search,font=("goudy old style",15),bg="#4caf50",fg="white",cursor="hand2").place(x=980,y=79,width=100,height=28)
        ...
        #R4#
        lbl_descriptiion=Label(self.root,text="Description",font=("goudy old style",15),bg="white").place(x=50,y=200)
    
        self.txt_desc=Text(self.root,font=("goudy old style",15),bg="lightyellow")
        self.txt_desc.place(x=180,y=200,width=470,height=120)

        #BUTTONS#
        butn_add=Button(self.root,text="Save",command=self.add,font=("goudy old style",15),bg="#2196f3",fg="white",cursor="hand2").place(x=180,y=370,width=110,height=35)
        butn_update=Button(self.root,text="Update",command=self.update,font=("goudy old style",15),bg="#2196f3",fg="white",cursor="hand2").place(x=300,y=370,width=110,height=35)
        butn_delete=Button(self.root,text="Delete",command=self.delete,font=("goudy old style",15),bg="#2196f3",fg="white",cursor="hand2").place(x=420,y=370,width=110,height=35)
        butn_clear=Button(self.root,text="Clear",command=self.clear,font=("goudy old style",15),bg="#2196f3",fg="white",cursor="hand2").place(x=540,y=370,width=110,height=35)
