...
class employeeClass:
    def __init__(self, root):
        ...
        lbl_contact=Label(self.root,text="Conatct",font=("goudy old style",15),bg="white").place(x=750,y=150)
        ...
        #BUTTONS#
        butn_add=Button(self.root,text="Save",command=self.add,font=("goudy old style",15),bg="#2196f3",fg="white",cursor="hand2").place(x=500,y=305,width=110,height=28)
        butn_update=Button(self.root,text="Update",command=self.update,font=("goudy old style",15),bg="#2196f3",fg="white",cursor="hand2").place(x=620,y=305,width=110,height=28)
        butn_delete=Button(self.root,text="Delete",command=self.delete,font=("goudy old style",15),bg="#2196f3",fg="white",cursor="hand2").place(x=740,y=305,width=110,height=28)
        butn_clear=Button(self.root,text="Clear",command=self.clear,font=("goudy old style",15),bg="#2196f3",fg="white",cursor="hand2").place(x=860,y=305,width=110,height=28)
