...
class productClass:
    def __init__(self, root):
        ...
        #COLUMN 2#
        cmb_cate=ttk.Combobox(product_Frame,textvariable=self.var_cate,values=self.cat_list,state='readonly',justify=CENTER,font=("goudy old style",15))
        cmb_cate.place(x=150,y=60,width=200)
        cmb_cate.current(0)
        ...
        #BUTTONS#
        butn_add=Button(product_Frame,text="Save",command=self.add,font=("goudy old style",15),bg="#2196f3",fg="white",cursor="hand2").place(x=10,y=400,width=100,height=40)
        butn_update=Button(product_Frame,text="Update",command=self.update,font=("goudy old style",15),bg="#2196f3",fg="white",cursor="hand2").place(x=120,y=400,width=100,height=40)
        butn_delete=Button(product_Frame,text="Delete",command=self.delete,font=("goudy old style",15),bg="#2196f3",fg="white",cursor="hand2").place(x=230,y=400,width=100,height=40)
        butn_clear=Button(product_Frame,text="Clear",command=self.clear,font=("goudy old style",15),bg="#2196f3",fg="white",cursor="hand2").place(x=340,y=400,width=100,height=40)
        ...
        butn_search=Button(SearchFrame,text="Search",command=self.search,font=("goudy old style",15),bg="#4caf50",fg="white",cursor="hand2").place(x=410,y=9,width=150,height=30)
    ...
    def add(self):
        ...
        cur=con.cursor()
        try:
            if self.var_cate.get()=="Select" or self.var_cate.get()=="Empty" or self.var_sup.get()=="Select" or self.var_sup.get()=="Empty" or self.var_name.get()=="":
