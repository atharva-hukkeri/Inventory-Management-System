...
class salesClass:
    def __init__(self, root):
        ...
        #TITLE#
        lbl_title=Label(self.root,text="View Customer Bills",font=("goudy old style",30),bg="#184a45",fg="white").pack(side=TOP)
        ...
        btn_clear=Button(self.root,text="Clear",command=self.clear,font=("times new roman",15,"bold"),bg="#2196f3",fg="white",cursor="hand2").place(x=490,y=100,width=120,height=28)
        ...
        bill_Frame.place(x=400,y=140,width=610,height=330)
